...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def go_to_joint_state(self):
    ...
    box_pose.pose.position.x = 0.143
    box_pose.pose.position.z = 0.24
    box_pose.pose.position.y = 0.098
    box_name = "box"
    scene.add_box(box_name, box_pose, size=(0.02, 0.02, 0.06))
